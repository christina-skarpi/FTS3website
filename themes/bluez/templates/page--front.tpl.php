...
<div id="wrapper">
  ...
  <!-- Header Ends -->
   ...
   <!--front_page_release_block Starts-->
      <?php print render($page['front_page_release_block']); ?>
   <!--front_page_release_block Ends-->

   <!-- search_Box_Area START -->
       <?php print render($page['search_box_area']); ?>
   <!-- search_Box_Area Ends -->
  ...
  <!--Three Column Blocks Ends -->
   ...
   <!-- bubble_icon_Area START -->
       <?php print render($page['bubble_icon']); ?>
   <!-- bubble_icon_Area Ends -->
  
   <!-- phrases_area_Area START -->
       <?php print render($page['phrases_area']); ?>
   <!-- phrases_area_Area Ends -->

   <!-- data_anevue_area STARTs -->
       <?php print render($page['data_anevue_area']); ?>
   <!-- data_anevue_area Ends -->
